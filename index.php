...
<head>
  ...
  <title>Hacked By FVCKHATERS</title>
...
<body>
  <div class="hero">
    ...
    <p style="color: #ccc">
      A suffocating shadow has settled over this nation—not from the lack of
      potential, but from the abundance of
      <span class="red-highlight">normalized betrayal</span>. We watch
      <span class="red-highlight">justice being auctioned off</span>
      in broad daylight while those in power flaunt their greed without a
      shred of shame. How long are we expected to keep loving a system that
      actively bleeds us dry? And at what point do we realize that the
      promises we were sold were just
      <span class="red-highlight">elegant lies to keep us quiet?</span>
    </p>
  </div>
</body>
